...
CONFIG_DEFAULTS = {
    ...
    'restringir_subs': True, 'nivel_sub_minimo': 500, 'restringir_mods': False,
    ...
    'alerta_likes_persona': False, 'meta_likes_persona': 50, 'repetir_likes_persona': True,
    'url_regalo': 'https://www.myinstants.com/media/sounds/rupee-collect.mp3', 'url_follow': 'https://www.myinstants.com/media/sounds/zelda-navi-listen.mp3', 'url_like_general': '', 'url_like_persona': '',
    ...
    'perm_sub_play': False, 'perm_sub_skip': False, 'perm_sub_pause': False,
    'perm_sub_resume': False, 'perm_sub_vol': False,
    'perm_mod_play': False, 'perm_mod_skip': False, 'perm_mod_pause': False,
    'perm_mod_resume': False, 'perm_mod_vol': False,
    ...
    def eliminar_cancion_lista(self):
        try:
            ...
            if seleccion:
                ...
                self.actualizar_lista_musica_ui()
                self.agregar_log(f'[BÚSQUEDA] Canción en índice {index + 1} eliminada de la cola.')
        except Exception as e:
            self.agregar_log(f'[Error UI]: {e}')
    ...
    while True:
        ...
        try:
            ...
            async def on_connect(event: ConnectEvent):
                ...
                gui.agregar_log(f'[SISTEMA] Conectado exitosamente al Live de @{clean_id}')
            ...
            async def on_like(event: LikeEvent):
                ...
                if not gui.conectado:
                    ...
                    if gui.alerta_likes_persona.get() and like_goal_reached:
                        gui.agregar_log(
                            f'[LIKES PERSONA] @{normalizar_texto(username)} alcanzó {reached_milestone} likes'
                        )
