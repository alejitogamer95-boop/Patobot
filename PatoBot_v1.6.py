...
class PanelControl:
    def __init__(self):
        ...
        ttk.Label(f_regalos_head,text='Sonido (URL)').pack(side='left',padx=(80,4))
        ...
        self.btn_agregar_alerta_regalo=tk.Button(f_regalos_buttons,text='＋ Agregar alerta',bg='#a6e3a1',fg='#11111b',relief='flat',font=(self.fuente_actual,9,'bold'),command=self.agregar_alerta_regalo); self.btn_agregar_alerta_regalo.pack(side='left',padx=2)
        self.btn_actualizar_regalos=tk.Button(f_regalos_buttons,text='↻ Actualizar regalos',bg='#89b4fa',fg='#11111b',relief='flat',font=(self.fuente_actual,9,'bold'),command=self.actualizar_catalogo_desde_tiktok); self.btn_actualizar_regalos.pack(side='left',padx=4)
        ...
        frame_emotes_personalizados = ttk.LabelFrame(self.tab_alertas, text=' Alertas de emotes personalizados ')
        ...
        ttk.Label(f_emotes_head, text='Emote').pack(side='left', padx=(5,4))
        ttk.Label(f_emotes_head, text='Nombre').pack(side='left', padx=(55,4))
        ttk.Label(f_emotes_head, text='Sonido (URL)').pack(side='left', padx=(45,4))
        ...
        self.btn_agregar_alerta_emote = tk.Button(f_emotes_buttons, text='＋ Agregar alerta', bg='#a6e3a1', fg='#11111b', relief='flat', font=(self.fuente_actual,9,'bold'), command=self.agregar_alerta_emote)
        self.btn_agregar_alerta_emote.pack(side='left', padx=2)
        self.lbl_catalogo_emotes = ttk.Label(f_emotes_buttons, text='😀 Esperando emotes del Live...')
    ...
    def agregar_alerta_regalo(self, regalo='', sonido='', activar=True):
        ...
        tk.Button(fila,text='▶',width=3,bg='#89b4fa',fg='#11111b',relief='flat',font=(self.fuente_actual,8,'bold'),command=lambda e=entry: reproducir_sonido_url(e.get().strip())).pack(side='left',padx=2)
